...
import backgroundImg from "assets/img/gallery/Reportages/Le-retour-du-loup-en-Dordogne/2/medium_2.jpg";
...
const jpg = jpegFiles.directories.Reportages.directories["Le-retour-du-loup-en-Dordogne"].directories
const webp = webpFiles.directories.Reportages.directories["Le-retour-du-loup-en-Dordogne"].directories



export function WolfDordogne() {

	const { classes } = useStyles();
	const { t } = useTranslation({ WolfDordogne })
